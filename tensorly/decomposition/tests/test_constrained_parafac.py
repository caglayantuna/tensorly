...
def test_constrained_parafac():
    ...
    constraints = ['nonnegative', 'sparse_l1', 'l2', 'unimodality', 'normalize', 'simplex', 'normalized_sparsity', 'soft_sparsity', 'smoothness', 'monotonicity']
    for i in constraints:
        fac, errors = constrained_parafac(tensor, constraints=i, rank=rank, init=init, random_state=rng, return_errors=True)
